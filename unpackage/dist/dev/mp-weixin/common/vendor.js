...
/* 街鎮 */exports.countyList = countyList;
...
/* 设施类型 */exports.streetTownList = streetTownList;
var facilityTypeList = function facilityTypeList(data) {
  //设置请求结束后拦截器
  _interface.default.interceptor.response = function (response) {
    return response;
  };
...
/*设施点详情 */exports.facilityTypeList = facilityTypeList;
